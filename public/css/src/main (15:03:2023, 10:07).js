...
$('.supress').on('click', function(event) {
...
$(function(){
  console.log ("++==================== 1Network Manager  Started! ");
...
$('#fileToUpload').on('change',function(event){ event.preventDefault();loadfile(event)});

$('#thumbsUppp').on('change', function(e){ e.preventDefault(); loadfile(e)});
...
//=========================== load file
function echo(mx){console.log(mx)}
async function loadfile(event) {
const xmyFile = (event.id==null)? event.target: event;

  hostpathname ="http://onetv.ng/images/uploads/";
...
//============================ Build ajax Selector ============================================================
  ...
  if(ct=0)  count();
    ...
    let rText = "";
      ...
      if (xurl.includes(playyt)&&xcode=="SHYP")   rText= xurl.replace(playlistyt,playlistemebedyt);
                     ...
                     if(usernameRegex.test(cid)){
                      info.innerHTML ="";
                        ...
                        if(cid.length > 4){
                           ...
                           xhttp.open("GET", "https://onetv.ng/server/cid.ajaxdbcheck.php?cid="+cid, true); 
