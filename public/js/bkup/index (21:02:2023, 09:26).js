...
function createNewChannel(ev) {
  ev.preventDefault();
  //alert("here 000");
  var valid;

let move = false;
  valid = true; //validateNewChannel();
  
  //valid = false; //validateNewChannel();
...
//alert (upUrl);
 ...
 // document.getElementById("info").value= player.videoTitle;
  ...
  case "SHYP":
                                      ...
                                      eSrc= streamUrl.replace (playlistyt,playlistemebedyt);
