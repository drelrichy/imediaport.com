  ...
  <div draggable="true" class="boxx">
    ...
    `;
        ...
        if(player.M=="player"){
            ...
            isPlayer= true;
            this.isPlayer= true;
            console.log("we are playing ooh!!")
        }
...
// ;this.assetList = sentlist ;
        ...
        this.assetList.forEach((program, p) => {
           ...
           //xloadup=`<iframe id='player' src="https://www.youtube.com/embed/${this.assetList[p].video_id}?autoplay=1&t=${startTrim}" allow="autoplay"></iframe> `;


             // loadup=`<iframe width="1003" height="564" src="https://www.youtube.com/embed/${this.assetList[p].video_id}?autoplay=1&t=${startTrim}" title="You Are Mine Episode 1 (Long Version)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`;
              //console.log(loadup);
             // console.log("Our video","|"+this.assetList[p].video_id+"|");
...
function externalClock() { // console.log("clocking outside...");
    ...
    if (playtime.isPlayer && player) {
     if(playtime.isPlayer) var   lexxt =player.getVideoData();//.title
     if(playtime.isPlayer)  $("#info2").html(lexxt.title);
    };
