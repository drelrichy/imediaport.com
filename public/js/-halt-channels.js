    ...
    case "all":
                        ...
                        for (let index = 0; index < dataArr.length; index++) {
                            ...
                            xchan = xchanbox[index];
                             if(iptvc=="all") makeMenu("dynamicmenu", xchanbox[index],index); // Add new values to selection box Two
                       ...
                       if(isNowSET!=true) {
                        ...
                        case "sortmenu":
                       feedSelect=feedSelect.toLowerCase();
                        ...
                        if (feedSelect=="entertainment"&&ifedey("movie,music,comedy",feedSelect))isAGO= true;
                        searchit=  searchit.toLowerCase();
                        if(searchit.includes(feedSelect))isAGO= true;
    
                        console.log(feedSelect+" from ->"+ searchit);
                     if(iptvc=="sortmenu"&& isAGO) makeMenu("dynamicmenu", xchanbox[index],index); // Add new values to selection box Two
...
//alert(document.getElementById("navhost").style.visibility);
 ...
 // };
 $("#mxcontrol").css("visibility", "visible");
  ...
  $("#navhost").css("visibility",  "visible");
...
function ggetchannels(iptvc ,feedSelect) {
  ...
  switch (iptvc){
    ...
    case "all":
                       ...
                       feedSelect=feedSelect.toLowerCase();
                        ...
                        //console.log(feedSelect+" from ->"+ searchit);
                     if(iptvc=="sortmenu"&& isAGO) makeMenu("dynamicmenu", xchannels[index],index); // Add new values to selection box Two
...
case "all":
                    ...
                    let  xchan =  JSON.parse( dataArr[index]);
                         ...
                         if(iptvc=="all") makeMenu("dynamicmenu",  xchan ,index); // Add new values to selection box Two
...
let nindex=xindex+10;
        $('#' + parentID).append(
      '<a tabindex="'+nindex+'"       alt="'+channel.cid+'"  id="'+channel.cid+'"    tips="'+channel.cInfo+'"      name="'+channel.cFname+'"  class="dymen listmen"  onclick="  ciPlay(this,this.src)" href="#'+channel.cid+'"  >'+channel.cid.toUpperCase()+' </a>'
  ...
  console.log(itx);
    ...
    let  isAGO= false;
      ...
      for (const check of ari) {
        ...
        if (feedSelect.includes(check)) isAGO =true;
